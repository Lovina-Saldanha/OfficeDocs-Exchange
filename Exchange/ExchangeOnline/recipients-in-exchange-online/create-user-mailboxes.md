...
For more information on adding users in Microsoft 365 admin center, see [Add users and assign licenses](https://docs.microsoft.com/microsoft-365/admin/add-users/add-users).
